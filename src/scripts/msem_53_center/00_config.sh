...
export RENDER_PROJECT="slab_000_to_009" # default project to first cut

export BASE_DATA_DIR="/nrs/${LAB_OR_PROJECT_GROUP}/data"
export DATA_RAW_DIR="${BASE_DATA_DIR}/hess_wafer_53/raw"
...
N5_PATH="${BASE_DATA_DIR}/hess_wafer_53/export/${RENDER_OWNER}.n5"
